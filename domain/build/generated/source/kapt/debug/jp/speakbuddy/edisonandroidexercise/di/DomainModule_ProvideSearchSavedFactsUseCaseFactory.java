...
public final class DomainModule_ProvideSearchSavedFactsUseCaseFactory implements Factory<SearchSavedFactsUseCase> {
  private final Provider<FactRepository> repositoryProvider;

  public DomainModule_ProvideSearchSavedFactsUseCaseFactory(
  ...
  public static DomainModule_ProvideSearchSavedFactsUseCaseFactory create(
      Provider<FactRepository> repositoryProvider) {
    return new DomainModule_ProvideSearchSavedFactsUseCaseFactory(repositoryProvider);
  }

  public static SearchSavedFactsUseCase provideSearchSavedFactsUseCase(FactRepository repository) {
    return Preconditions.checkNotNullFromProvides(DomainModule.INSTANCE.provideSearchSavedFactsUseCase(repository));
  }
}
